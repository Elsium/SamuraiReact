	...
	return (
		<nav className={style.nav}>
			<div className={style.main}>
				<p><a href="/profile" className={style.ref}>
				...
				<p><a href="/news" className={style.ref}>
					<svg width="25" height="25" stroke-width="1.5" viewBox="0 0 24 24" fill="none">
				...
				<p><a href="/messages" className={msgclass}>
				...
				<p><a href="/music" className={style.ref}>
					<svg width="25" height="25" stroke-width="1.5" viewBox="0 0 24 24" fill="none">
			...
			<a href="/settings" className={style.ref}>
				<svg width="25" height="25" stroke-width="1.5" viewBox="0 0 24 24" fill="none">
