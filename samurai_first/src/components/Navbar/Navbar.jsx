...
const Navbar = (props) => {
	...
	if (props.msg > 0) msgclass = style.ref + " " + style.newMsg;
	else msgclass = style.ref;
	
	if (props.msg < 9) msgsize = style.sizef;
	else if (props.msg < 99) msgsize = style.sizes;
	else msgsize = style.sizet;
	
	
	return (
		<nav className={style.nav}>
			<div className={style.main}>
				<p><Link to="/profile" className={style.ref}>
				...
				<p><Link to="/news" className={style.ref}>
					<svg width="25" height="25" stroke-width="1.5" viewBox="0 0 24 24" fill="none">
						<path d="M12 19C12 14.8 9.2 12 5 12" stroke="currentColor" stroke-linecap="round"
							  stroke-linejoin="round"/>
						<path d="M19 19C19 10.6 13.4 5 5 5" stroke="currentColor" stroke-linecap="round"
							  stroke-linejoin="round"/>
						<path d="M5 19.01L5.01 18.9989" stroke="currentColor" stroke-linecap="round"
							  stroke-linejoin="round"/>
					</svg>
					<span>News</span>
				</Link></p>
				<p><Link nonexactly to="/messages" className={msgclass}>
					<div className={style.item}>
						<p className={msgsize}>{props.msg}</p>
						<svg width="25" height="25" stroke-width="1.5" viewBox="0 0 24 24" fill="none">
							<path
				...
				<p><Link to="/music" className={style.ref}>
					<svg width="25" height="25" stroke-width="1.5" viewBox="0 0 24 24" fill="none">
			...
			<p className={style.settings}>
				<Link to="/settings" className={style.ref}>
					<svg width="25" height="25" stroke-width="1.5" viewBox="0 0 24 24" fill="none">
						<path
